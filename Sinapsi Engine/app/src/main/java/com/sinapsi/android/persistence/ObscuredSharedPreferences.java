...
/**
 * ObscuredSharedPreferences class.
...
public class ObscuredSharedPreferences implements SharedPreferences {
    ...
    private class Editor implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putStringSet(String key, Set<String> values) {
            ...
            for(String stmp: values)
                tmp.add(encrypt(stmp));
            delegate.putStringSet(key, tmp);
            return this;
        }
    ...
    public Set<String> getStringSet(String key, Set<String> defValues) {
        ...
        for(String stmp: defValues)
            result.add(decrypt(stmp));
        return result;
    }
